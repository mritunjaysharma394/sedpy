...
The project follows [PEP-8](https://www.python.org/dev/peps/pep-0008/) Style of Coding. You can use [yapf](https://github.com/google/yapf) tool to simplify this task.
